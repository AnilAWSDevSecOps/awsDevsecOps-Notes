...
- Now browse the application with IP:8000  
  ![012](https://github.com/AnilAWSDevSecOps/awsDevsecOps-Notes/blob/main/Python_Scripting/Notes-Images/012.png)
...
- Now if you browse the application with below url you will get pokemon and VPCs
  ...
  ```
  ![013](https://github.com/AnilAWSDevSecOps/awsDevsecOps-Notes/blob/main/Python_Scripting/Notes-Images/013.png)
  ```
  http://3.82.28.32:8000/vpcs/us-east-1

  ```
  ![014](https://github.com/AnilAWSDevSecOps/awsDevsecOps-Notes/blob/main/Python_Scripting/Notes-Images/014.png)
...
- Now to make front end look wise good we need to add few things.
  ...
  ```
  ![015](https://github.com/AnilAWSDevSecOps/awsDevsecOps-Notes/blob/main/Python_Scripting/Notes-Images/015.png)
