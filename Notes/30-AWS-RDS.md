...
- Come to Amazon RDS > Subnetgroup > Create DB Subnet group
  ![994](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/994.png)

- Fill in the details.

  ![995](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/995.png)
  ![996](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/996.png)
  ![997](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/997.png)

- RDS > Database > Create database
  ![998](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/998.png)
  ![999](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/999.png)
  ![1000](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1000.png)
  ![1001](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1001.png)
  ![1002](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1002.png)
  ![1003](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1003.png)
  ![1004](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1004.png)
  ![1005](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1005.png)
  ![1006](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1006.png)
  ![1007](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1007.png)
  ![1008](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1008.png)
  ![1008-01](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1008-1.png)

- Diagram Demonstrating the Database Architecture
  ![1009](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1009.png)
...
- After installing it looks like this when you open the workbench app.
  ![1010](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1010.png)

## Connecting RDS in WorkBench

- Copy the Database Endpoint.    
  ![1012](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1012.png)
  ```
  demoapp-database-1.cxia00csqptb.us-east-1.rds.amazonaws.com
  ```
- Click on Plus button
  ![1013](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1013.png)

- Fill in the details, Name, Hostname(RDS Endpoint) and click on test connection.
  ![1014](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1014.png)

- Enter the password and clcik on ok.
  ![1015](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1015.png)

- You will get the successful message.
  ![1016](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1016.png)

- Click ok to finish and add the RDS in the work bench.
  ![1017](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1017.png)

- RDS Added successfully. oprn it.
  ![1018](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1018.png)
  ![1019](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1019.png)

- It looks this way.
  ![1020](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1020.png)

- Under schemas in home page click on Add button.
  ![1021](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1021.png)
...
- Now clcik on Execute button.
  ![1022](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1022.png)


- Now we can connect through Linux Servers, for that we will launch the Ubuntu server
  ![1011](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1011.png)
...
- Now we write a code in python.
  ...
  ```
  ![1023](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1023.png)

- Now browse with below url
  ```
  http://34.207.96.253:8080
  ```
  ![1024](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1024.png)

- After ping once in browser
  ![1025](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1025.png)
...
- Now browse in Browser
  ...
  ```
  ![1026](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1026.png)

- Now we will do failover of RDS.
  ![1027](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1027.png)
  ![1028](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1028.png)
  ### app.py
  ```
  import sqlalchemy as sal
  import pymysql
  ...
  ```
  ![1029](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1029.png)

  ```
  nslookup demoapp-database-1.cxia00csqptb.us-east-1.rds.amazonaws.com
  ```
  ![1030](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1030.png)
  ![1031](https://github.com/DevopsAllInOne/01-AWS-2024/blob/main/Notes-Images/940-1407/1031.png)
